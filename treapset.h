...
extern treapset *node_init(treapset *root, TREAPTYPE value, int priority, char *str);
extern treapset *treap_insert_p(treapset *root, TREAPTYPE value, int priority, char *str);
